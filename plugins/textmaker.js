        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/devil.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/devil.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/sci.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/sci.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textleaf ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
}));
...
Asena.addCommand({pattern: 'textabear ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    var buffer_data = await axios.get(img.image, { responseType: 'arraybuffer'})
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by HYPER-X', mimetype: Mimetype.gif })
}));
...
Asena.addCommand({pattern: 'textpubg ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(buffer_data.data), MessageType.video, { mimetype: Mimetype.png, caption: 'Made by HYPER-X', mimetype: Mimetype.mp4 })
}));
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/devil2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/devil2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/hub.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/hub.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/retr.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/retr.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t3gr.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t3gr.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bry.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bry.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t4snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t4snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t3snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t3snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/snd.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/snd.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/fh.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/fh.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tpink.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tpink.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cbld.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cbld.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bld.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bld.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2lgh.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2lgh.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/robo.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/robo.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/3dl.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/3dl.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tart.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tart.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wcolor.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wcolor.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/magma.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/magma.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/metal.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/metal.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/papert.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/papert.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/glass.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/glass.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t5neon.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t5neon.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tgrone.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tgrone.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/hp2n.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/hp2n.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/stone.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/stone.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/bear.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/bear.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/wolf.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/wolf.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/li.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/li.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/joker.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/joker.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ninja.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ninja.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/marvel.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/marvel.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/mar2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/mar2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/aven.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/aven.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2gl.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2gl.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tt2.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tt2.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ttgra.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ttgra.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t2gra.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t2gra.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/lion.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/lion.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/neon3.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/neon3.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/ice.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/ice.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        [`${topText}`, `${bottomText}`]
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/space.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/space.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/smoke.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/smoke.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
...
Asena.addCommand({pattern: 'textglow ?(.*)', fromMe: wk, dontAddCommandList: true}, (async (message, match) => {
    ...
    await download(`https://api.xteam.xyz/photooxy/neonlight?text=${uri}&APIKEY=da5fb2b73ae3e451`, '/root/WhatsAsenaDuplicated/glowttp.png', async() => {                          
        await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/glowttp.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
    })
}));
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/tfire.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/tfire.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/hp.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/hp.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/t4n.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/t4n.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cmth.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cmth.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
        ...
        `${match[1]}`
          ...
          try { 
              ...
              await download(`${data}`, '/root/WhatsAsenaDuplicated/cup.png', async() => {                          
                  await message.client.sendMessage(message.jid,fs.readFileSync('/root/WhatsAsenaDuplicated/cup.png'), MessageType.image, { mimetype: Mimetype.png, caption: 'Made by HYPER-X' })
              })
          } catch(err) { 
              console.log(err)
          } 
